...
int print_ip_hdr(WINDOW *win, unsigned char const* buf, int bufsize)
{
...
int print_icmp_hdr(WINDOW *win, unsigned char const* buf, int bufsize)
{
...
void print_icmp_packet(WINDOW *win, unsigned char const* buf, int bufsize)
{
